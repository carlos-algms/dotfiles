...
vim.keymap.set('n', '<leader>pf', builtin.find_files, { desc = '[pf] Find all files in the current folder' })
vim.keymap.set('n', '<C-p>', builtin.git_files, { desc = '[C-p] Find all files in the current git repository' })
