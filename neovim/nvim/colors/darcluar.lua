...
local theme = {
    ...
    links = {
        ...
        ["@markup.heading.1.markdown"] = "Keyword",
        ["@markup.heading.2.markdown"] = "Keyword",
        ["@markup.heading.3.markdown"] = "Keyword",
        ["@markup.heading.4.markdown"] = "Keyword",
        ["@markup.heading.5.markdown"] = "Keyword",
        ["@markup.heading.6.markdown"] = "Keyword",
        ["@markup.heading.markdown"] = "Keyword",
        ["@markup.heading"] = "@none",
        ...
        gitcommitBranch = "Function",
        gitcommitDiscardedFile = "String",
        gitcommitHeader = "Keyword",
        gitcommitSelectedFile = "String",
        gitcommitUntrackedFile = "String",
        htmlArg = "@identifier",
        htmlEndTag = "@tag",
        htmlHead = "@none",
